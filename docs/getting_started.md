...
# A from-scratch setup script for CUDA11.1.
...
cd pytorch
git switch release/1.6
git submodule sync
git submodule update --init --recursive
export CMAKE_PREFIX_PATH=${CONDA_PREFIX:-"$(dirname $(which conda))/../"}
vim caffe2/utils/GpuDefs.cuh
# Change line 11
# From: #if __CUDA_ARCH__ <= 800
# To: #if __CUDA_ARCH__ <= 1000
python setup.py install

git clone --recursive https://github.com/pytorch/vision
cd vision
git switch release/0.7
vim /home/rjchen/softwares/anaconda3/envs/c2d2/lib/python3.7/site-packages/torch/utils/cpp_extension.py
# line 1385
# From: ('Ampere', '8.0+PTX'),
# To: ('Ampere', '8.0;8.6+PTX'),
# line 1389
# From: '7.0', '7.2', '7.5', '8.0']
# To: '7.0', '7.2', '7.5', '8.0', '8.6']
vim setup.py
# line 175
# From: has_ffmpeg = ffmpeg_exe is not None
# To: has_ffmpeg = False
python setup.py install

# install mmcv
pip install mmcv-full==1.4.5 -f https://download.openmmlab.com/mmcv/dist/cu111/torch160/index.html --no-cache-dir
