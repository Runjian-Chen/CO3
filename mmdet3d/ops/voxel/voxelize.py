...
from .voxel_layer import dynamic_voxelize, hard_voxelize, hard_voxelize_with_voxel_idx
    ...
    def forward(ctx,
        ...
        if max_points == -1 or max_voxels == -1:
            ...
            if not return_voxel_idx:
                ...
                voxels_coors = points.new_zeros(
                    size=(points.size(0), 3), dtype=torch.int)
                voxel_num = hard_voxelize_with_voxel_idx(points, voxels, coors,
                                          num_points_per_voxel, voxel_size,
                                          coors_range, max_points, max_voxels, voxels_coors, 3,
                                          deterministic )
            ...
            if not return_voxel_idx:
                ...
                return voxels_out, coors_out, num_points_per_voxel_out, voxels_coors
...
class Voxelization(nn.Module):
    ...
    def forward(self, input, return_voxel_idx = False):
        """
        Args:
            input: NC points
        """
        ...
        return voxelization(input, self.voxel_size, self.point_cloud_range,
                            ...
                            self.deterministic, return_voxel_idx)
