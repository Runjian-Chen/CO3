...
class contextual_shape_prediction_loss(nn.Module):

    def __init__(self, sample_num=2048, fileter_ground_points = False, in_channels = 16, out_channels = 32, topk_nearest=200):
        super(contextual_shape_prediction_loss, self).__init__()
    ...
    def forward(self,
        ...
        contextual_shape_prediction_loss = torch.zeros(1).to(vehicle_points[0].device)
        ...
        for b in range(batch_size):
            ...
            # Sample points from vehicle-side and apply contextual prediction loss
            ...
            contextual_shape_prediction_loss += 10.0 * self.kld(predicted_dist.log(), gt_dist)

            # Fusion side contextual prediction loss
            if self.fileter_ground_points:
            ...
            # sample points from fusion side and apply contextual prediction loss
        ...
        return contextual_shape_prediction_loss