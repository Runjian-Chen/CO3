...
from mmdet3d.ops.roiaware_pool3d.points_in_boxes import points_in_boxes_gpu
...
class BaseInstance3DBoxes(object):
    ...
    def points_in_boxes_gpu(self, points, boxes_override=None):
        ...
        box_idx = points_in_boxes_gpu(points,
